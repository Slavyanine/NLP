import Tokenize #подключение ранее реализованного токенизатора
import pymorphy2
import math
import copy
import pandas as pd
...
# по результатам кластеризации наблюдается сохранение связи между словами из одной тематики-объединяются в один кластер
